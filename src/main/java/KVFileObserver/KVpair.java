...
//        result.setTableName(schema.getTableName());
        ...
        //decode the header
        ArrayList<HeaderOfKValue> hdrs = this.getHdrsOfColumns(this.value);
...
//            hdr.show();
    ...
    private ArrayList<HeaderOfKValue> getHdrsOfColumns(byte[] KVpairValueArray) {
        ...
        ArrayList<HeaderOfKValue> hdrs = new ArrayList();
